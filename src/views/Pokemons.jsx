...
export default function Pokemons() {
	...
	return (
		<div className="position-relative  ">
			<div className="div position-absolute top-0 start-50 translate-middle-x mt-4">
				<h2 className="text-center text-black">Selecciona un Pokemon</h2>
				<select
					value={selected}
				...
				<button
					onClick={handleClick}
					className="btn  p-2 ms-3 mb-2 fw-bolder"
					type="button"
				>
					BUSCAR
				</button>
